...
//   inifileName - a file name that will appear in the edit box of the dialog, set to 0 if not
//                 needed
//   defExt      - the default extension which is appended if not extension provided by user,
//                 0 if not needed
...
String name;          // _T("mumble.txt") or including initial path
                      // _T("D:\Sources\Data\mumble.txt")
String ext;           // _T("txt")
